...
$templateCache.put("{widgetsPath}/pagebuilder/src/view.html","<roargrid config=config collection={{config.id}}></roargrid><div ng-include=config.url></div><div ng-bind-html=page.data></div>");}]);})(window);