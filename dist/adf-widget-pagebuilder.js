...
$templateCache.put("{widgetsPath}/pagebuilder/src/videoplayer.html","<video-bg video-id=config.videoId ratio=config.ratio loop=config.loop mute=config.mute start=config.start content-z-index=config.contentz allow-click-events=config.clickevents></video-bg>");
